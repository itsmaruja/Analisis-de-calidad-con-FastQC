...
```{r}
setwd("C:/Users/valen/OneDrive/Documents/FACU/Año 2/bioinformatica/fastqfilesc")
```

2. Crear el objeto: 

```{r}
setwd("/Users/valen/OneDrive/Documents/FACU/Año 2/bioinformatica/fastqfilesc")

checkpoint("Rqc", path= "/Users/ignaciocassol/Dropbox/materias de grado/Bioinformática/fastq_files_qc",{
  files <- c("filtered_and_trimmed.fastq", "hola.fastq")
